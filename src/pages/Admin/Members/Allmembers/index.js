      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        <Table stickyHeader aria-label="sticky table">
          <TableHead sx={{ display: "table-header-group" }}>
            ...
            <TableCell style={{minWidth:100,fontSize:12,backgroundColor: "",fontWeight:"900",borderBottom: "2px solid #2a68af",color:"#2a68af"}} align="right">APPOINTMENT DATE</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
          {searchTerm === '' &&(
